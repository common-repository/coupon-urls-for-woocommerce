...
class Stringy implements Countable, IteratorAggregate, ArrayAccess
{
     ...
     *         __toString method is passed as the first argument
     */
    public static function create($str = '', $encoding = null) : Stringy
    {
     ...
     */
    public function append($string) : Stringy
    {
     ...
     */
    public function at($index) : Stringy
    {
     ...
     */
    public function between($start, $end, $offset = 0) : Stringy
    {
     ...
     */
    public function delimit($delimiter) : Stringy
    {
