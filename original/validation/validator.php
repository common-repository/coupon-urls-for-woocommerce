...
abstract class Validator
{
    ...
    public abstract function execute() : ValidationResult;
    /**
     ...
     */
    protected abstract function getDefaultException() : Exception;
    /**
     * @throws \Exception
     */
    public function validate() : void
    {
        ...
        if ($validationResult->isFailing()) {
            (object) ($exception = $validationResult->setExceptionWhenNoCustomExceptionHasBeenSet($this->getException())->getException());
            throw new $exception();
        }
    }
    /**
    ...
    /**
     * @param bool|\CouponURLs\Original\Validation\Validator $isTrueOrValidatorHasPassed
     */
    protected function passWhen($isTrueOrValidatorHasPassed) : ValidationResult
    {
