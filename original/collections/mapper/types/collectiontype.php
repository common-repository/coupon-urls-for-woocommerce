...
class CollectionType extends Types
{
    ...
    )
    {
        ...
        (bool) ($itAllowsEmptyValuesButAllPassedValuesWerentAllowed = $this->allowEmptyValue && $filteredValues->haveNone() && $valuesCollection->haveAny() && !$valuesCollection->containAll($this->ignorableValues));
