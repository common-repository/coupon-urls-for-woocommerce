...
class ArrayGetter
{
    public static function getArrayOrThrowExceptionFrom($value)
    {
        ...
        throw new BadMethodCallException(\esc_html("Error: method expects parameter to be array or ArrayRepresentation, " . gettype($value) . ' given.'));
    }
    public static function getFlattenArrayOrThrowExceptionFrom($value)
    {
        /*array|null*/
        $arrayValue = static::getArrayOrThrowExceptionFrom($value);
