...
{
    /**
     * @var \CouponURLs\Original\Construction\Data\WP_QueryFactory
     */
    protected $WP_QueryFactory;
    public function __construct(WP_QueryFactory $WP_QueryFactory)
    {
        $this->WP_QueryFactory = $WP_QueryFactory;
    }
    /**
    ...
    public function findMany(Parameters $parameters) : Collection
    {
        ...
        return neblabs_collection([$posts->posts]);
    }
    /**
