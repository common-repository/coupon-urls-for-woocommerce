...
class Services
{
    ...
    {
        $this->services = neblabs_collection([]);
    }
    ...
    {
        $this->services = $this->services->filter(function (Service $service) use ($serviceToRemove) {
            return $serviceToRemove !== $service;
        });
    }
    public function has(string $id) : bool
    {
        return $this->services->have(function (Service $service) use ($id) {
    ...
    {
        return $this->services->find(function (Service $service) use ($id) {
            return $service->id() == $id;
        });
    }
}