...
class InstallEvent
{
    ...
    {
        register_activation_hook(Env::absolutePluginFilePath(), [$this, 'activateOnce']);
    }
    ...
    {
        return (int) get_option($name = $this->getHasRunOptionName(), $default = static::HAS_NOT_RUN) === static::HAS_RUN;
    }
    protected function updateHasRunToTrue()
    {
        update_option($name = $this->getHasRunOptionName(), $value = static::HAS_RUN);
    }
