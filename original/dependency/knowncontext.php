...
class KnownContext implements Context
{
     ...
     */
    protected $fullyQualifiedTypeName;
    /**
     * @var \CouponURLs\Original\Characters\StringManager
     */
    ...
    public function __construct(StringManager $fullyQualifiedTypeName, StringManager $methodName, StringManager $variableName)
    {
    ...
    {
        return $firstString->is($secondString, true);
    }
