...
class UnProccesedRegisteredDependencyTypes implements GettableCollection
{
    ...
    {
        (object) ($registeredTypes = new GettableCollectionDecorator(new ByFileGettableCollection(new OriginalDependencyTypes()), new ByFileGettableCollection(new AppDependencyTypes())));
