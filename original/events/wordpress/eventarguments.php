...
class EventArguments extends Collection
{
    ...
    {
        $elements = neblabs_collection([$elements])->asArray();
         ...
         */
        parent::__construct($this->convertToObject($elements));
    }
    /**
     * @return mixed
     */
    public function convertToObject(array $items)
    {
        ...
        return array_map(function ($item) use ($arrayIsListFunction) {
