...
class ActionComponentsRegistrator extends BaseComponentsRegistrator implements ComponentsRegistrator
{
    ...
    {
        return new Validators([new ItemsAreOnlyInstancesOf($componentsToRegister, neblabs_collection([Identifiable::class])), new ItemsAreOnlyInstancesOf($componentsToRegister, neblabs_collection([Nameable::class]))]);
    }
}