...
class CouponURLsFeaturesExporter implements DashboardExportable
{
    ...
    {
        return ['buttons' => ['dashboardLauncher' => apply_filters('cu.dashboardLauncher.isEnabled', true), 'saveButton' => apply_filters('cu.saveButton.isEnabled', true), 'backButton' => apply_filters('cu.backButton.isEnabled', true)]];
    }
}