...
class ActionComponentsDependency implements Cached, StaticType, Dependency
{
    ...
    {
        return new Components(neblabs_collection([new AddCouponComponent(), new CouponToBeAddedNotificationMessageComponent(), new AddProductComponent(), new CouponAddedToCartExtraNotificationMessageComponent(), new RedirectionComponent()]));
    }
}